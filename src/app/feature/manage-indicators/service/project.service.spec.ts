...
describe('ProjectService', () => {
  ...
  it('should call GET with pagination to consult projects paginated', () => {
    service.consultarProyectosPaginado(0, 10).subscribe();
    const req = httpMock.expectOne(r => r.url === `${environment.endpoint}/proyectos/paginado`);
    expect(req.request.method).toBe('GET');
