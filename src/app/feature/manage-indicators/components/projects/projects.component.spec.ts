...
describe('ProjectsComponent', () => {
  ...
  const mockPaginatedResponse: PaginatedResponse<ProjectResponse> = {
    contenido: mockProyectos,
    totalElementos: 2,
    totalPaginas: 1,
    paginaActual: 0
  };
  ...
  beforeEach(() => {
    mockProjectService = jasmine.createSpyObj('ProjectService', ['consultarProyectosPaginado']);
    mockProjectService.consultarProyectosPaginado.and.returnValue(of(mockPaginatedResponse));
  ...
  describe('ngOnInit', () => {
    it('should load projects', () => {
      fixture.detectChanges();
      expect(mockProjectService.consultarProyectosPaginado).toHaveBeenCalled();
      expect(component.proyectos).toEqual(mockProyectos);
    });
  });

  describe('cargarProyectos', () => {
    it('should populate projects and pagination data', () => {
    ...
    it('should pass trimmed searchTerm', () => {
      ...
      component.cargarProyectos();
      expect(mockProjectService.consultarProyectosPaginado).toHaveBeenCalledWith(0, 10, 'test');
    });

    it('should handle null contenido', () => {
      mockProjectService.consultarProyectosPaginado.and.returnValue(of({
    ...
    it('should handle error', () => {
      mockProjectService.consultarProyectosPaginado.and.returnValue(throwError(() => new Error('fail')));
      component.cargarProyectos();
  ...
  describe('cambiarPagina', () => {
    it('should set page and reload', () => {
      ...
      expect(mockProjectService.consultarProyectosPaginado).toHaveBeenCalledWith(3, 10, undefined);
    });
  });
  ...
  describe('onProyectoModificado', () => {
    it('should reload projects and clear selection', () => {
      mockProjectService.consultarProyectosPaginado.calls.reset();
