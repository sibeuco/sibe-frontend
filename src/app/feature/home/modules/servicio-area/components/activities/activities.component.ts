...
export class ActivitiesComponent implements OnInit {
  ...
  private readonly NOMBRE_AREA = 'Servicio y atención al usuario';
  ...
  cargarActividades(): void {
    ...
    this.areaService.consultarPorNombre(this.NOMBRE_AREA).pipe(
      switchMap(area => {
        return this.activityService.consultarPorArea(area.identificador);
      }),
